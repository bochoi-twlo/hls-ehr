...
$result = getPatientData($pidForEhr, "*, DATE_FORMAT(DOB,'%Y-%m-%d') as DOB_YMD");


//tokens to compare
$_SESSION['token_main_php'] = 'token';
$_GET['token_main'] = 'token';
//set auth data
$_SESSION['site_id'] = 'default';
$_SESSION['authUser'] = 'admin';
$_SESSION['authPass'] = '$2y$10$3I4s/DDBq7n6U/sQ5wiB3.c1lrNvJa0plk5l4TIVTbYwkFtAAOF7W';
...
<script>
    ...
    function setMyPatient() {
        ...
        if (isset($pidForEhr)) {
            ...
            ?>
        left_nav.setPatient(<?php echo js_escape($result['fname'] . " " . $result['lname']) .
